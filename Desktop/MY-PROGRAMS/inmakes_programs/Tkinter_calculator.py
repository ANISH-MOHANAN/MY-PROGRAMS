...
#get the user input and place it in the text box
i=0
...
#to clear everything using AC button
def clear_all():
    display.delete(0,END)

#to delte 1 position at at time using <- button
def undo():
...
#to claculate when pressing = button
def calculate():
    entire_string=display.get()
    try:
